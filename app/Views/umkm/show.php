...
<div class="row">
  <div class="my-3">
    <!-- Information Card of UMKM -->
    <div class="card border-0 shadow components-section">
      <!-- Card Header -->
      <div class="card-header d-flex justify-content-between align-items-center py-2 px-3">
        <a role="button" href="<?= base_url("admin/umkm"); ?>" class="btn btn-secondary btn-sm d-inline-flex align-items-center">
        ...
        <div>
          ...
          <form class="d-inline" action="<?= site_url("admin/umkm/" . $umkm->id); ?>" method="POST">
            <?= csrf_field(); ?>
      ...
      <div class="card-body">
        ...
        <table class="table table-borderless w-auto ms-2 mb-3">
          <tbody>
            <tr>
              <th class="fw-bold" scope="row">Nama UMKM</th>
              <td>:&nbsp;<?= $umkm->nama_umkm; ?></td>
            </tr>
            <tr>
              <th class="fw-bold" scope="row">Nomor Telepon UMKM</th>
              <td>:&nbsp;<a href="http://wa.me/<?= $umkm->nomor_telepon; ?>/?text=%5BPesan%20dari%20Rumah%20BUMN%20Denpasar%5D%0ASelamat%20_%3F_%2C%20semoga%20bapak%2Fibu%20selalu%20diberi%20kesehatan.%0AKami%20dari%20Rumah%20BUMN%20Denpasar%2C%20Bali." target="_blank"></a><?= $umkm->nomor_telepon; ?><img class="ps-1" src="<?= base_url("images/icons/whatsapp.png"); ?>" alt="Logo WA" height="23"></td>
            </tr>
            <tr>
              <th class="fw-bold" scope="row">Alamat UMKM</th>
              <td class="text-capitalize">:&nbsp;<?= $umkm->alamat; ?></td>
            </tr>
          </tbody>
        </table>
      </div>
