...
class AuthController extends Controller
{
	...
	public function logout()
	{
		...
		return redirect()->to(site_url('login'))->with("success", lang('Berhasil keluar. Silahkan masuk kembali.'));
	}
	...
	public function attemptRegister()
	{
		...
		// Save the user
		$allowedPostFields = array_merge(['password_hash'], $this->config->validFields, $this->config->personalFields);
		...
		if ($this->config->requireActivation !== null) {
			...
			// Success!
			return redirect()->route('home')->with('message', lang('Auth.activationSuccess'));
		}

		// Success!
		return redirect()->route('home')->with('message', lang('Auth.registerSuccess'));
	}
	...
	public function attemptReset()
	{
		...
		return redirect()->back()->with('message', lang('Auth.resetSuccess'));
	}
