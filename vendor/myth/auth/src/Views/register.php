                ...
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        ...
                        <?php if ($config->validFields === ['email']) : ?>
                            <div class="form-group mb-2 d-flex flex-column">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control <?php if (session('errors.email')) : ?>is-invalid<?php else : "is-valid";
                                                                                                                                        endif ?>" placeholder="<?= lang('Auth.email') ?>" id="email" value="<?= old('email') ?>" autofocus>
                                </div>
                    ...
                    <div class="form-group mb-2  d-flex flex-column">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="username" class="form-control <?php if (session('errors.username')) : ?>is-invalid<?php else : "is-valid";
                                                                                                                                    endif ?>" placeholder="<?= lang('Auth.username') ?>" id="username" value="<?= old('username') ?>">
                        </div>
                    ...
                    <div class="form-group mb-2  d-flex flex-column">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password_hash" placeholder="********" class="form-control <?php if (session('errors.password_hash')) : ?>is-invalid<?php else : "is-valid";
                                                                                                                                                                        endif ?>" id="password_hash" autocomplete="off">
                        </div>
                    ...
                    <div class="form-group mb-2  d-flex flex-column">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="pass_confirm" placeholder="********" class="form-control <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php else : "is-valid";
                                                                                                                                                                        endif ?>" id="pass_confirm" autocomplete="off">
                        </div>
